...
/* @brief Set product support e-mail address.
	*/
BUGTRAP_API void APIENTRY BTKantar_SetApplicationFile(TCHAR* fileName);

/* @brief Set product support e-mail address.
	*/
BUGTRAP_API void APIENTRY BTKantar_SetApplicationFilesContainingInfo(TCHAR* path, TCHAR* _infoInFileName);
