...
Module mEasyCrypt
    ...
    Public Function Crypter(ByVal Texte As String, ByVal type As String) As String
        ...
        Select Case type
            ...
            Case "ripemd160"
                ' Hachage
                TexteHache = ripemd160.ComputeHash(TexteEnBit)
                'Libération des ressources 
                ripemd160.Clear()
        ...
        ' Renvoi 
        Crypter = ByteArrayToString(TexteHache)
    End Function
