...
{
	m_bkg.SetBkColor(CATPColors::GetColorMedium(m_appColor),CATPColors::COLORNOAPP, CATPColors::LIGHT_DEGRAD);
	m_bkgMargeErreur.SetBkColor(CATPColors::GetColorMedium(m_appColor),CATPColors::COLORNOAPP, CATPColors::LIGHT_DEGRAD);
	...
	m_PrctMargeUtil.SetBkColor(CATPColors::GetColorMedium(m_appColor),CATPColors::COLORNOAPP, CATPColors::LIGHT_DEGRAD);
	m_PrctMargeAppli.SetBkColor(CATPColors::GetColorMedium(m_appColor),CATPColors::COLORNOAPP, CATPColors::LIGHT_DEGRAD);
