#if !defined(AFX_ATPECHELLE_F1_H__INCLUDED_)
#define AFX_ATPECHELLE_F1_H__INCLUDED_
...
class CATPEchelle_F1 : public JFCGrid
{
public:
	// le constructeur
	CATPEchelle_F1();
...
protected:
	//{{AFX_VIRTUAL(CATPEchelle_F1)
	virtual void PreSubclassWindow();
	//}}AFX_VIRTUAL

protected:
	//{{AFX_MSG(CATPEchelle_F1)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
#endif // !defined(AFX_ATPECHELLE_F1_H__INCLUDED_)
