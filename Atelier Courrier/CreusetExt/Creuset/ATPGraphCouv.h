#if !defined(AFX_ATPGraphCouv_H__3B3DA0CA_5C09_4F33_9257_0BC9910B9701__INCLUDED_)
#define AFX_ATPGraphCouv_H__3B3DA0CA_5C09_4F33_9257_0BC9910B9701__INCLUDED_
...
class CATPGraphCouv : public JFCFlatPane
{
public:
	// le constructeur
	CATPGraphCouv();
...
protected:
	//{{AFX_VIRTUAL(CATPGraphCouv)
	//}}AFX_VIRTUAL

protected:
	//{{AFX_MSG(CATPGraphCouv)
...
private:
	...
	CATPGraphCouv_B1 m_B1; // le composant B1
	CAbscisseGrph	m_A2;
	JFCTruc m_btnPrint;
};
...
#endif // !defined(AFX_ATPGraphCouv_H__3B3DA0CA_5C09_4F33_9257_0BC9910B9701__INCLUDED_)
