...
//////////////////
// le constructeur
IMPLEMENT_DYNCREATE(CATPCreusetHypoQP, CATPCreusetHypo)

CATPCreusetHypoQP::CATPCreusetHypoQP()
{
	if(m_E2)
		delete m_E2;
	m_E2 = new CATPCreusetHypoQP_E2();
...
//LONG CATPCreusetHypoQP::GetCXMin()
//{
...
//}
//
//LONG CATPCreusetHypoQP::GetCYMin()
//{
...
//}
//
//LONG CATPCreusetHypoQP::GetCYIdeal()
//{
//	// on calcule la hauteur des composants
...
BEGIN_MESSAGE_MAP(CATPCreusetHypoQP, CATPCreusetHypo)
	//{{AFX_MSG_MAP(CATPCreusetHypoQP)
	ON_WM_CREATE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
int CATPCreusetHypoQP::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	// Titre Bloc Support
	LONG x1_A1 = CATPCreusetHypo_Metriques::CX_Border();             LONG x2_A1 = x1_A1 + CATPCreusetHypo_Metriques::CX_AxQP();
	...
	// 
	LONG x1_E1 = x2_A1 + CATPCreusetHypo_Metriques::CX_Interstice(); LONG x2_E1 = x1_E1 + CATPCreusetHypo_Metriques::CX_CxQP();
...
//	LONG y1_HS = y2_C3 + CATPCreusetHypo_Metriques::CY_Interstice()+ (CATPCreusetHypo_Metriques::CY_x4()-CATPCreusetHypo_Metriques::CY_HS())/2; LONG y2_HS = y1_HS + CATPCreusetHypo_Metriques::CY_HS(); // centré
	...
	if (m_A3.Create(NULL, WS_VISIBLE, CRect(x1_A3, y1_A3, x2_E3, y2_A3), this, 0) == FALSE) return (-1);
	...
	if (m_E3.Create(NULL, 0, CRect(x1_E3, y1_E3, x2_E3, y2_E3), this, 0) == FALSE) return (-1);
