#if !defined(AFX_ATPECHELLEQP_D2_H__)
#define AFX_ATPECHELLEQP_D2_H__
...
class CATPEchelleQP_D2 : public JFCGrid
{
public:
	// le constructeur
	CATPEchelleQP_D2();
...
protected:
	//{{AFX_VIRTUAL(CATPEchelleQP_D2)
	virtual void PreSubclassWindow();
	//}}AFX_VIRTUAL

protected:
	//{{AFX_MSG(CATPEchelleQP_D2)
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
#endif // !defined(AFX_ATPECHELLEQP_D2_H__)
