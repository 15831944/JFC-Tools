// SineQuaNon.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CSineQuaNonApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CSineQuaNonApp

CSineQuaNonApp::CSineQuaNonApp()
{
...
// Seul et unique objet CSineQuaNonApp

CSineQuaNonApp theApp;


// initialisation CSineQuaNonApp

BOOL CSineQuaNonApp::InitInstance()
{
	...
	if(cmdInfo.m_dico == CATPComm::ANG)
	{
		...
		m_pszAppName=_tcsdup(_T("SineQuaNon ANG"));
	}
