...
void CPathDlg::SetColors()
{
	...
	m_lblSrc.SetBkColor(CATPColors::GetColorMedium(CATPColors::COLORLANCEUR),CATPColors::COLORLANCEUR, CATPColors::DARK_DEGRAD);

	m_lblUser.SetBkColor(CATPColors::GetColorMedium(CATPColors::COLORLANCEUR), CATPColors::COLORLANCEUR, CATPColors::DARK_DEGRAD);
