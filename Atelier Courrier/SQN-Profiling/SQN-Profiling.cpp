// SQN-Profiling.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CSQNProfilingApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CSQNProfilingApp

CSQNProfilingApp::CSQNProfilingApp()
{
...
// Seul et unique objet CSQNProfilingApp

CSQNProfilingApp theApp;


// initialisation CSQNProfilingApp

BOOL CSQNProfilingApp::InitInstance()
{
	// InitCommonControls() est requis sur Windows XP si le manifeste de l'application
	// spécifie l'utilisation de ComCtl32.dll version 6 ou ultérieure pour activer les
	// styles visuels.  Dans le cas contraire, la création de fenêtres échouera.

	// AfxMessageBox("Verif Profiling / Step 1", MB_ICONINFORMATION);

	InitCommonControls();

	CWinApp::InitInstance();

	// AfxMessageBox("Verif Profiling / Step 2", MB_ICONINFORMATION);
	...
	// AfxMessageBox("Verif Profiling / Step 3", MB_ICONINFORMATION);
