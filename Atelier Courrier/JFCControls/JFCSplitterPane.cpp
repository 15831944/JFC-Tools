...
JFCSplitterPane::JFCSplitterPane(): JFCPane()
{
}
...
JFCSplitterPane::~JFCSplitterPane()
{
}

void JFCSplitterPane::PostNcDestroy( )
{
	delete this;
}

BEGIN_MESSAGE_MAP(JFCSplitterPane, JFCPane)
	//{{AFX_MSG_MAP(JFCSplitterPane)
	ON_WM_PAINT()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

void JFCSplitterPane::RemoveScroll(CWnd * pWnd)
{
	m_Items.RemoveKey(pWnd);
}

void JFCSplitterPane::OnPaint() 
{
	RECT Rect;
