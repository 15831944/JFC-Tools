...
// Message événement click bourton droit 
...
{
public:
    // CButtonST(CATPColors::APPCOLOR AppColor)
	CButtonST();
	~CButtonST();
...
public:
	...
	DWORD SetColor(BYTE byColorIndex, COLORREF crColor, CATPColors::APPCOLOR AppColor = CATPColors::COLORNOAPP, BOOL bRepaint = TRUE);
...
public:
	...
	virtual void SetAppColor(CATPColors::APPCOLOR AppColor) { m_CATPColorsApp = AppColor; };
...
protected:
	...
	BOOL		m_bIsBtnMenu;		///< Is the button, un bouton menu déroulant
	
	BOOL		m_bIsFlecheG;		///< Is the button avec flèche à gauche
	BOOL		m_bIsFlecheD;		///< Is the button avec flèche à droite
