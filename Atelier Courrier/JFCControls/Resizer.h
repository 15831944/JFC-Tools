...
//
//	Descriptif:
//	Classe de retaillage des Dialog, lui preferer ETSLayout
*/
...
public:
  ...
  ///Adds border info to an initialized CResizer.
  bool Add(const CBorderInfo *pBorders, int nSize);

  ///Performs moving of controls
  void Move() const;

  // Cache et décahe les contrôles
  void HideCtrl() const;
  void ShowCtrl() const;
