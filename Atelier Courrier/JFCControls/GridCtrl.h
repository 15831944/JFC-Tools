...
public:
	...
	void EnableFitToPage(BOOL bEnable = TRUE) { m_bFitToPage = bEnable;     }
    BOOL GetFitToPage()                       { return m_bFitToPage;        }
...
protected:
    ...
    LRESULT SendMessageToParent(int nRow, int nCol, int nMessage, POINT point) const;
