 ...
 */
const int nDefaultBorder	= 2;

/**
 * The minimum size for not ABSOLUTE_XXX items
 */
const int nMinConstrain = 4;

class AFX_EXT_CLASS ETSLayoutMgr
{
public:
...
*/
	 ...
	 */
	struct AFX_EXT_CLASS PaneHolder
	{
	...
	class Pane;
	class AFX_EXT_CLASS CPane : public CPaneBase
	{
	public:
		// Standardconstructor
		CPane( );
	 ...
	 */
	class AFX_EXT_CLASS PaneItem : public PaneBase {
		friend class ETSLayoutMgr;
		friend class Pane;
	protected:
		/**
	 ...
	 */
	class AFX_EXT_CLASS Pane : public PaneBase {
		friend class ETSLayoutMgr;
		friend class CPaneBase;
		friend class CPane;
        friend class ETSLayoutPropertySheet;
	 ...
	 * childs
	 */
	class AFX_EXT_CLASS PaneTab : public Pane
	{
		friend class ETSLayoutMgr;
	 ...
	 * childs
	 */
	class AFX_EXT_CLASS PaneCtrl : public Pane
	{
		friend class ETSLayoutMgr;
	protected:
		/**
 ...
 */
class AFX_EXT_CLASS ETSLayoutDialog : public ETSLayout::CBaseDialog, protected ETSLayoutMgr
{
// Construction
public:
 ...
 */
class AFX_EXT_CLASS ETSLayoutFormView : public ETSLayout::CBaseFormView, public ETSLayoutMgr
{
// Construction
 ...
 * ETSLayoutDialogBar
 */
class AFX_EXT_CLASS ETSLayoutDialogBar : public ETSLayout::CBaseDialogBar, protected ETSLayoutMgr
{
// Construction
public:
#ifdef CS_HELP
 ...
 */
class AFX_EXT_CLASS ETSLayoutPropertySheet : public CPropertySheet, protected ETSLayoutMgr
{
 ...
 */
class AFX_EXT_CLASS ETSLayoutPropertyPage : public ETSLayout::CBasePropertyPage, protected ETSLayoutMgr
{
friend class ETSLayoutPropertySheet;
