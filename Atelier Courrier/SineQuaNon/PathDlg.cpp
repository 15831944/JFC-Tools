...
{
	m_bk.SetBkColor(CATPColors::GetColorMedium(CATPColors::COLORLANCEUR),CATPColors::COLORNOAPP, CATPColors::LIGHT_DEGRAD);
	...
	m_lblSrc.SetBkColor(CATPColors::GetColorMedium(CATPColors::COLORLANCEUR),CATPColors::COLORLANCEUR, CATPColors::MEDIUM_DEGRAD);
	
	m_lblUser.SetBkColor(CATPColors::GetColorMedium(CATPColors::COLORLANCEUR),CATPColors::COLORLANCEUR, CATPColors::MEDIUM_DEGRAD);
	...
	m_btnPathSrc.SetColor( CButtonST::BTNST_COLOR_BK_IN, CATPColors::GetColorLight(CATPColors::COLORLANCEUR) );
	m_btnPathSrc.SetColor( CButtonST::BTNST_COLOR_BK_OUT, CATPColors::GetColorMedium(CATPColors::COLORLANCEUR) );
	m_btnPathSrc.SetColor( CButtonST::BTNST_COLOR_BK_FOCUS, CATPColors::GetColorDark(CATPColors::COLORLANCEUR) );
	m_btnPathSrc.SetIcon(IDI_ATP_FOLDER);

	m_btnPathUser.SetColor( CButtonST::BTNST_COLOR_BK_IN, CATPColors::GetColorLight(CATPColors::COLORLANCEUR) );
	m_btnPathUser.SetColor( CButtonST::BTNST_COLOR_BK_OUT, CATPColors::GetColorMedium(CATPColors::COLORLANCEUR) );
	m_btnPathUser.SetColor( CButtonST::BTNST_COLOR_BK_FOCUS, CATPColors::GetColorDark(CATPColors::COLORLANCEUR) );
