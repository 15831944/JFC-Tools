 ...
 *
 */
class AFX_EXT_CLASS CIBModalite : public IBloc  
{
public:
	CIBModalite();
	virtual ~CIBModalite();
	...
	/// Adds a value
	virtual void AddValue(JInt32 Value);
...
private:
	CIBModalite(const CIBModalite & rhs);
	CIBModalite & operator=(const CIBModalite & rhs);
