 ...
 *
 */
class CHasItemVisitor : public IItemVisitor  
{
public:
	CHasItemVisitor();
	virtual ~CHasItemVisitor();
	virtual JBool HasItem(CIBuilder *pBuilder, CItemsConstruitsBase *pItemConst,JInt32 ItemID);
