 ...
 *
 */
class CToEquivalenceVisitor : public IAbsolutVisitor  
{
public:
	CToEquivalenceVisitor();
	virtual ~CToEquivalenceVisitor();

	/// Convert the Reperes to equivalence reperes
	virtual JBool Convert(CABuilder *pBuilder, CTerrain * pTerrain, CItemsConstruitsBase *pItemConst);
