 ...
 *
 */
class CItemVisitor : public IItemVisitor  
{
public:
	CItemVisitor();
	virtual ~CItemVisitor();

	virtual JBool GetItemsID(CIBSegment *pSegment, JList<JInt32> &ItemID);
	virtual CIBItem * FindItem(CIBSegment *pSegment, JInt32 Itid=0);
	virtual JBool HasItems(CIBSegment *pSegment);
