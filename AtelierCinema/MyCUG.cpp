...
{
	///////////////////////////
	// declare un object CUGCell
	CUGCell cell;


	///////////////////////////
	// définit la fonte choisie
	int font_idx = AddFont("Arial", 12, 2);
	CFont * myFont = GetFont(font_idx);

	/////////////////////////////////////////////
	// Définit le defaut pour toutes les cellules
	GetGridDefault(&cell);
	cell.SetFont(myFont);
	cell.SetReadOnly(FALSE);
	cell.SetMask("CCCCCCCCCC");
	SetGridDefault(&cell);

	//////////////////////////
	// Definit le defaut pour les colonnes de titres
	GetHeadingDefault(&cell);
	cell.SetFont(myFont);
	cell.SetBackColor(RGB(200,200,200));
	cell.SetReadOnly(TRUE);
	SetHeadingDefault(&cell);


	///////////////////////////
	// definition du nombre de lignes et de colonnes
	SetNumberCols(5);
	SetNumberRows(3);
	...
	// definit le titre la cellule -1, -1
	QuickSetText (-1, -1, "Libellé Complexe");
	
	/////////////////
	// Definit les titres des entêtes colonnes
	QuickSetText (-1, 0, "BELLEY ARLEQUIN");
	QuickSetText (-1, 1, "LAON");
	QuickSetText (-1, 2, "FORUM");
	...
	//////////////////////////////////
	// Definit la hauteur des colonnes
	...
	/////////////////
	// Definit les titres des entêtes lignes
	QuickSetText (0, -1, "Code Complexe");
	QuickSetText (1, -1, "Régie");
	QuickSetText (2, -1, "Entrées Semaine");
	QuickSetText (3, -1, "Part de voix sur cible");
	QuickSetText (4, -1, "Entrées Semaine sur cible");

	/////////////////////
	// Definit le texte d'une cellule
/*
	GetCell(1, 1, &cell);
	cell.SetBackColor(RGB(0,0,189));
	cell.SetText("Ucgref");
	SetCell(1,1, &cell);
*/
}
