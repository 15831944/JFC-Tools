...
// 2/ on prend toujours le numéro de semaine du samedi en ajoutant 1 si le premier samedi de l'année est à 0

int CCAlendrierHebdoCinema::GetNumSemaine(COleDateTime date)
{
...
int CCAlendrierHebdoCinema::GetIndexSemaine(COleDateTime date)
{
	return GetNumSemaine(date)-1;
}
